...
export default function Hero() {
  ...
  return (
    <section id="home" className="bg-WhiteColor text-black">
      <div className="mx-auto max-w-5xl w-5/6 flex flex-col pt-20 md:pt-0 items-start md:flex-row justify-between md:items-center">
        <div className="flex flex-col">
          ...
          <a className={`${didot.className} mt-4 flex gap-3 items-center justify-center text-WhiteColor bg-blackColor transition-all duration-200 hover:opacity-75 px-6 py-2 font-bold text-xl md:text-2xl`} href={`https://api.whatsapp.com/send?phone=${process.env.NUMBER}&text=Oi,%20Tudo%20bem!`}>
            Agendar horário
            <FaWhatsapp />
          </a>
        </div>
