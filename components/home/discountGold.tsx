...
export default function DiscountGold() {
    ...
    return (
        <section className="bg-goldColor">
            <div className="flex gap-6 mx-auto w-5/6 max-w-5xl py-16">
                <div className="flex flex-col justify-center items-start">
                    ...
                    <Link className={`w-fit mt-4 flex gap-3 items-center justify-center text-WhiteColor bg-black transition-all duration-200 hover:opacity-75 px-12 py-2 font-bold text-2xl`} href={`https://api.whatsapp.com/send?phone=554797713257&text=Oi,%20Tudo%20bem!`} target="_blank" aria-label="Agende agora pelo WhatsApp">
                        <FaWhatsapp />
                        Agende agora
                    </Link>
                </div>
